...
const staticData: AchievementItem[] = [
  {
    ...
    url_credential: "https://drive.google.com/file/d/1iyosTsk-XrFKfv6dAu5yEDrSRHyV5dQB/view?usp=sharing",
  ...
  },
  {
    ...
    url_credential: "https://drive.google.com/file/d/1ontZitkOe3u63oEykwTpojrGO6XhSs88/view?usp=sharing",
    category: "awards",
    is_show: true,
  },
  {
    ...
    url_credential: "https://drive.google.com/file/d/1QVkzNABZnln4k8Uwkg1tb_Qghf-9W4c9/view?usp=sharing",
    category: "awards",
    is_show: true,
  },
  {
    ...
    image: "/images/achievements/certificates/freecodecamp_javascript_dataStructure.png",
    url_credential: "https://drive.google.com/file/d/1RTZgjVud35M9RQUBZAnQNDunFCmd3p-v/view?usp=sharing",
    category: "certificate",
    is_show: true,
  },
  {
    ...
    url_credential: "https://drive.google.com/file/d/1ayMNucUO4KNXlQ-jVm4kYNDak-uyxCSG/view?usp=sharing",
    category: "certificate",
    is_show: true,
  }
];
    ...
    <Link href={url_credential} className="flex h-full" target="_blank">
      <Card className="group flex h-full flex-col overflow-hidden">
        <div className="relative">
          ...
          />
          <div className="absolute left-0 top-0 flex h-full w-full items-center justify-center gap-1 rounded-t-lg bg-black text-sm font-medium opacity-0 transition-opacity duration-300 group-hover:opacity-80 text-white">
            <ViewIcon size={20} />
          </div>
        </div>
        <div className="my-auto space-y-2 p-4 flex flex-col justify-between h-full">
          {credential_id && (
