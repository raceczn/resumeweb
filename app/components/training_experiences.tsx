import { TrainingData } from "../lib/resume/types";
import { Timeline } from "./Timeline";

const resumeData: TrainingData = {
  experiences: [
    {
    ...
    },
    {
      ...
      positions: [
        {
          title: "Web Design & JS Algorithms and Data Structures",
          description: [
            "Completed the Responsive Web Design certification by building projects using HTML and CSS.",
            "Learned CSS Flexbox and Grid to create responsive, mobile-friendly layouts.",
            "Earned the JavaScript Algorithms and Data Structures certification by solving coding challenges and building projects.",
            "Practiced writing clean, efficient code using functions, loops, arrays, and objects.",
